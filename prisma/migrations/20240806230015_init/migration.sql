...
-- CreateTable
CREATE TABLE "DownloadVerifications" (
    "id" TEXT NOT NULL,
    "expiresAt" TIMESTAMP(3) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "productId" TEXT NOT NULL,

    CONSTRAINT "DownloadVerifications_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DiscountCode" (
    "id" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    "discountAmout" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "DownloadVerifications" ADD CONSTRAINT "DownloadVerifications_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
